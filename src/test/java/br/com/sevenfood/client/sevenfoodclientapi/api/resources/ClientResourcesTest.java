package br.com.sevenfood.client.sevenfoodclientapi.api.resources;
...
import br.com.sevenfood.client.sevenfoodclientapi.util.CnpjGenerator;
...
class ClientResourcesDisabled {
    ...
    @Autowired
    private br.com.sevenfood.client.sevenfoodclientapi.core.service.ClientService service;
    ...
    @Mock
    private br.com.sevenfood.client.sevenfoodclientapi.application.api.mapper.ClientApiMapper clientApiMapper;
    ...
    void setup() {
        ...
        br.com.sevenfood.client.sevenfoodclientapi.core.domain.ClientType clientType = getClientCategory();
    ...
    private br.com.sevenfood.client.sevenfoodclientapi.core.domain.ClientType getClientCategory() {
        return br.com.sevenfood.client.sevenfoodclientapi.core.domain.ClientType.builder()
